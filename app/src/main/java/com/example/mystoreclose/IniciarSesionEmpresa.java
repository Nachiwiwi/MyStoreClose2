...
public class IniciarSesionEmpresa extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    private void iniciarsesion() {
        ...
        String url = "http://192.168.20.246/Android/iniciar_sesion_empresa.php?Rut_empresa=" + etuser.getText().toString()+"&ContraseñaDueño=" + etpwd.getText().toString();
        jrq = new JsonObjectRequest(Request.Method.GET, url, null, this, this);
        rq.add(jrq);
    }

    private void init(@NonNull View vista) {
